...
class TreasuryRateCardListController extends Controller
{
    ...
    //    / dd($data);
        $data = $data->map(function ($item, $key){ 
            //$item = (array)$item;
            $item['#'] = $key +1;
            $item['actions'] = '<img src="/asset/img/button_img/pen-green-32.png" alt="Button 2" class="button-image2" style="height: 25px; width: 25px;"></img>';
    ...
    // $rate_cards->rate_type = $request->input('a_rate_type');
       $rate_cards->rate_per_day = $request->input('a_rate_per_day');
       $rate_cards->new_rate_per_day = $request->input('a_new_rate_per_day');
