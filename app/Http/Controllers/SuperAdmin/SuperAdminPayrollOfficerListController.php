...
class SuperAdminPayrollOfficerListController extends Controller
{
    ...
    public function fetchData(Request $request)
    {
        ...
        $userType = $request->input('user_type', 'Payroll Officer');
    ...
    public function updateAccount(Request $request)
    {
            ...
            if ($validator->fails()) {
               // Alert::error('Registration Failed');
                ...
                return redirect(('/superadmin/payrollofficer/list'))->with('update-success', "Account updated successfully");
