...
class SuperAdminPayrollHeadListController extends Controller
{
    ...
    public function saveAccount(Request $request)
    {
            ...
            if ($validator->fails()) {
               // Alert::error('Registration Failed');
                return redirect('/superadmin/payrollhead')
                ...
                return redirect(('/superadmin/payrollhead'))->with('create-success', "Account registered successfully");
    ...
    public function updateAccount(Request $request)
    {
            ...
            if ($validator->fails()) {
               // Alert::error('Registration Failed');
                ...
                return redirect(('/superadmin/payrollhead'))->with('update-success', "Account updated successfully");
