...
class SuperAdminTreasuryListController extends Controller
{
    ...
    public function fetchData(Request $request)
    {
        ...
        $userType = $request->input('user_type', 'Treasury');
    ...
    public function saveAccount(Request $request)
    {
            ...
            if ($validator->fails()) {
               // Alert::error('Registration Failed');
                return redirect('/superadmin/treasury')
                ...
                return redirect(('/superadmin/treasury'))->with('create-success', "Account registered successfully");
    ...
    public function updateAccount(Request $request)
    {
            ...
            if ($validator->fails()) {
               // Alert::error('Registration Failed');
                ...
                return redirect(('/superadmin/treasury'))->with('update-success', "Account updated successfully");
