...
class PayrollHeadRfmListController extends Controller
{
    ...
    public function viewDoor()
    {
        ...
        $rfmPayrollheads = Payrollofficer::pluck(DB::raw("CONCAT(first_name, ' ', last_name) AS display_name"), 'id')->toArray();

        $rfmPayrollheadArray += $rfmPayrollheads;

        return view('payrollhead.view.rfmpayrollhead', compact('rfmPayrollheadArray'));
    }
    ...
    public function view_door(){
        ...
        ->toArray();
         ...
         $rfm_payrollhead_array += $coordinators;


        // dd($coordinator_array);
    
    
       return view('payrollhead.view.rfmpayrollhead' , compact('rfm_payrollhead_array' ));
