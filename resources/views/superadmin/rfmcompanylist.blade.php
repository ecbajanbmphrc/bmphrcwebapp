...
<body>
    ...
    <main class="bg-light">
        <div class="p-2">
            ...
            <nav class="px-3 py-2 bg-white rounded shadow-sm">
                ...
                <h5 class="fw-bold mb-0 me-auto">RFM CLient List</h5>
  ...
  <div class="card-body">
    ...
    <table id="rfm" class="table table-hover" style="width:100%">
        <thead>
            <tr>
                <th>#</th>
 ...
 <div class="modal fade" id="createAccountModal" name = "createAccountModal" tabindex="-1" role="dialog"  aria-labelledby="createAccountModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('superadmin.rfm-list.register')}}" method="POST">
        @csrf
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('superadmin.rfm-list.update-account')}}" method="POST">
...
<script src="/asset/user/js/bootstrap.bundle.min.js"></script>
    ...
    $(document).ready(function () {
        var dataTable = $('#rfm').DataTable({
            ajax: {
                url: '/superadmin/rfm/list/fetch-data',
                dataSrc: 'data'
            },
            columns: [
                { data: '#' },
    ...
    $('#rfm tbody').on('click', 'img.button-image2', function (e) {
        e.preventDefault();
            ...
            $.ajax({
            url: '/superadmin/rfm/list/retrieve-update/' + id ,
            type: 'GET', 
            dataType: 'JSON',
            headers: {
    ...
    $('#rfm tbody').on('click', 'img.button-image1', function (e) {
        e.preventDefault();
            ...
            $.ajax({
            url: '/superadmin/rfm/list/retrieve-view/' + id ,
            type: 'GET', 
            dataType: 'JSON',
            headers: {
                'Content-Type': 'application/json',
