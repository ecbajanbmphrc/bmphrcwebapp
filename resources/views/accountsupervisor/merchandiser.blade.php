    ...
    <link href="https://unpkg.com/gijgo@1.9.14/css/gijgo.min.css" rel="stylesheet" type="text/css" />
        ...
        // console.log(age);
            ...
            var date_started = $('#c_date_started').val();    
    
            var date_started = new Date(date_started).getTime();
            ...
            var date_started = $('#e_date_started').val();    
    
            var end_of_contract = $('#e_end_of_contract').val();

            var today = new Date().getTime(); 


            var total_days = Math.floor((date_started + end_of_contract) / (365.25 * 24 * 60 * 60 * 1000));
