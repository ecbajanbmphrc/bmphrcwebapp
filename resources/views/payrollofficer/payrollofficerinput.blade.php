...
<body>
    ...
    <div class="sidebar position-fixed top-0 bottom-0 border-end">
        ...
        <li class="sidebar-menu-item">
            ...
            <li class="sidebar-menu-item active mt-2 ">
    ...
    <main class="bg-light">
        <div class="p-2">
            ...
            <!-- new code for payroll inputs starts here -->

            <div style="height: 2vh;"></div>

            <!-- table input form starts here -->

            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h5 class="card-title">Input fields</h5>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-1">
                                <label for="" class="col-from-label">lorem</label>
            ...
            <!-- nwe code for payrollinputs ends here -->
