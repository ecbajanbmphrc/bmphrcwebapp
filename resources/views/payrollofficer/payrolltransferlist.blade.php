    ...
    <main class="bg-light">
        <div class="p-2">
            ...
            <nav class="px-3 py-2 bg-white rounded shadow-sm">
                ...
                <h5 class="fw-bold mb-0 me-auto">Transfer Payroll</h5>
            ...
            <div style="height:2vh;"> </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <h5 class="card-title">Transfered Payroll Table</h5>
                            </div>
                        </div>
        ...
        <script>
            $(document).ready(function(){
                var dataTable = $('#doortable').DataTable({
                    ajax: {
                        url: '/payrollofficer/payrollofficertransferlist/list/fetch-data',
                        dataSrc: 'dataone'
                    },
                    columns: [
                        { data: '#' },
