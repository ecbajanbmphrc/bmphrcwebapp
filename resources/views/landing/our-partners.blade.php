    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav ms-auto" style="margin-left: 5px;">
          ...
          <li class="nav-item">
            <a class="nav-link active mx-lg-2" href="{{ route('landing.our-partners') }}">Our Partners</a>
          </li>
          <li class="nav-item">
...
<div class="client-area">
    <div class="container-sm mb-5">
      <h2 class="mb-4 text-muted lead text-center mt-5" style="font-size: 40px;">Our Partners</h2>
